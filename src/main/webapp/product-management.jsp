                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 mb-0"><a href="/">Home</a> <span class="mx-2 mb-0">/</span>
                                    <strong class="text-black">Products management</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody>
                                                <c:forEach items="${product_list}" var="o">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit-product?product-id=${o.id}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row mb-5">
                                        ...
                                        <div class="modal fade bd-example-modal-lg" id="addProductModal" tabindex="-1"
                                                        ...
                                                        <div class="p-3">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input name="product-amount" type="number"
