                                    ...
                                    <div class="p-3 border">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input name="product-id" type="text" class="form-control" id="id"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input name="product-name" type="text" class="form-control" id="name"
                                                    value="${product.name}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="product-description" id="description" cols="30" rows="7"
